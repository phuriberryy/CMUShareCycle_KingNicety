  ...
  useEffect(() => {
    ...
    const handleStorage = (event) => {
      ...
      try {
        ...
        console.error('Failed to parse auth data from storage event:', err)
      }
    }

    window.addEventListener('sharecycle:logout', handleLogout)
    window.addEventListener('storage', handleStorage)
    return () => {
      window.removeEventListener('sharecycle:logout', handleLogout)
